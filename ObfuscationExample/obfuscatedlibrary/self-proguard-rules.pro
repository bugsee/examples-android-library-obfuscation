...
-keep class com.bugsee.shared.obfuscatedlibrary.data.DataClass { *; }
-keep class com.bugsee.shared.obfuscatedlibrary.data.DataClass$Type { *; }
-keep class com.bugsee.shared.obfuscatedlibrary.LibInterface { *; }
